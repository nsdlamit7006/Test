...
import { sampleWithRequiredData } from '../citymaster.test-samples';
import { CitymasterService } from '../service/citymaster.service';

import { CitymasterComponent } from './citymaster.component';
import SpyInstance = jest.SpyInstance;

describe('Citymaster Management Component', () => {
  let comp: CitymasterComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(CitymasterComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.citymasters?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to citymasterService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCitymasterIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCitymasterIdentifier).toHaveBeenCalledWith(entity);
